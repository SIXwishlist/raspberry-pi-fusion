...
<head>
  ...
  <title>Pi Fusion | Packages</title>
...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
			...
			<li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/system_packages.php"><i class="fa fa-server"></i> Software Packages</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Software packages <small>Overview</small></h1>
    </section>
       ...
       <!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Installed software packages table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
			<?php
			$output = shell_exec('dpkg -l | grep -v "| " | grep -v "=" | grep -v "Trig" | grep -v ")" | grep -v "+++-"');
			echo txt_to_html_table($output);
			?>	
            </div>
            <!-- /.box-body -->
          </div>
			...
			<table id="example2" class="table table-bordered table-striped">
				...
				<tr>
				  <?php 
					...
					for ($i=0; $i<$max-1; $i++) {
					?>	
					<td><?php echo $packages[$i]['install']; ?></td>
					<td><?php echo $packages[$i]['name']; ?></td>
					<td><?php echo $packages[$i]['version']; ?></td>
					<td><?php echo $packages[$i]['architecture']; ?></td>
					<td><?php echo $packages[$i]['description']; ?></td>
                </tr>
				<?php 
					}
				?> 
