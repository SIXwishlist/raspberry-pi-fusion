...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
            <li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/rpi_storage.php"><i class="fa fa-hdd-o"></i> Storage</a></li>				
              </ul>
            </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Storage information <small>Drives</small></h1>
    </section>
    ...
    <section class="content">
          ...
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Storage usage by partititions</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
			<?php
			echo storage_Usage() ['detail'];
			?>
            </div>
            <!-- /.box-body -->
          </div>
