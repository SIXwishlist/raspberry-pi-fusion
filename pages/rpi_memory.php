...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
            <li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/rpi_memory.php"><i class="fa fa-microchip"></i> Memory</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Memory information <small>SoC RAM</small></h1>
    </section>
	...
	<div class="row">
        ...
        <div class="col-md-12">
		   ...
		   <div class="box box-solid box-primary">
            <div class="box-header">
              <h3 class="box-title">Memory status view</h3>
            </div>
            <!-- /.box-header -->
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Memory info</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered table-striped">
				...
				<tr>
				  <?php 
				    $meminfo = ram_Mem_Info();
					$max = sizeof($meminfo);
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $meminfo[$i]['type']; ?></td>
					<td><?php echo $meminfo[$i]['size']; ?></td>
                </tr>
				<?php 
					}
				?> 
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">RAM usage <small>processes</small></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example3" class="table table-bordered table-striped">
				...
				<tr>
				  <?php 
					...
					$max = sizeof($ramdetails);
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $ramdetails[$i]['percentage']; ?></td>
					<td><?php echo $ramdetails[$i]['pid']; ?></td>
					<td><?php echo $ramdetails[$i]['user']; ?></td>
					<td><?php echo $ramdetails[$i]['command']; ?></td>
                </tr>
				<?php 
					}
				?> 
