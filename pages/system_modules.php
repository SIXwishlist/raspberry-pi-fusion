...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
			...
			<li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/system_modules.php"><i class="fa fa-server"></i> Kernel Modules</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Kernel modules <small>Overview</small></h1>
    </section>
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Installed kernel modules table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered table-striped">
				...
				<tr>
				  <?php 
					...
					?>	
					<td><?php echo $modules[$i]['module']; ?></td>
					<td><?php echo $modules[$i]['size']; ?></td>
					<td><?php echo $modules[$i]['used']; ?></td>
					<td><?php echo $modules[$i]['by']; ?></td>
                </tr>
				<?php 
					}
				?> 
