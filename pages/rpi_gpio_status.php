...
<head>
  ...
  <title>Pi Fusion | GPIO Status</title>
...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
			...
			<li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/rpi_gpio_status.php"><i class="fa fa-exchange"></i> GPIO Status</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>GPIO Status <small>Overview</small></h1>
    </section>
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">GPIO status table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered table-striped">
				...
				<tr>
				  <?php 
				    $gpiostatus = soc_GPIO_Status();
					$max = sizeof($gpiostatus);
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $gpiostatus[$i]['gpio']; ?></td>
					<td><?php echo $gpiostatus[$i]['level']; ?></td>
					<td><?php echo $gpiostatus[$i]['fsel']; ?></td>
					<td><?php echo $gpiostatus[$i]['alt']; ?></td>
					<td><?php echo $gpiostatus[$i]['func']; ?></td>
                </tr>
				<?php 
					}
				?> 
        ...
        <!-- /.col -->
		  ...
		  <div class="box box-solid box-default">
            ...
            <div class="box-body">
			  ...
			  <ul>
				<li>1 = High | 0 = Low</li>
				<li>Is only a reliable indication when GPIO is set to output!</li>
			  </ul>
			  Fsel:
			  <ul>
			  ...
			  ALT:
			  <ul>
                <li>Alternative function bank # of GPIO</li>
				<li>Further information about alternative GPIO functions here</li>
			  </ul>
			  Function:
			  <ul>
                <li>Current function of GPIO</li>
				<li>Further information about GPIO functions here</li>
			  </ul>
			  Status:
			  <ul>
