...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
          ...
          <ul class="treeview-menu">
			<li class="active"><a href="../pages/tools_phpinfo.php"><i class="fa  fa-info"></i> PHP Info</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>PHP Info <small>Information about PHP configuration</small></h1>
    </section>
	...
	<div class="row">
        <div class="col-md-12">
 	      <div class="box box-solid box-default">
			...
			<?php
			#echo '<pre>'.shell_exec("php -r 'phpinfo();'").'</pre>';  // output without any css style
			ob_start();
			phpinfo();
			$output = ob_get_contents();
			ob_end_clean();
			$output = preg_replace( '%^.*<body>(.*)</body>.*$%ms','$1',$output);
			echo $output;
			?>
