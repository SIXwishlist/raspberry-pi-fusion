...
<head>
  ...
  <title>Pi Fusion | GPIO Functions</title>
...
<aside class="main-sidebar">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
			<li class="active">
              ...
              <ul class="treeview-menu">
				<li class="active"><a href="../pages/docu_gpio_func.php"><i class="fa fa-book"></i> Functions Overview</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>GPIO Functions <small>Overview</small></h1>
    </section>
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">GPIO functions table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered table-striped">
				...
				<tr>
				  <?php 
				    $gpiofunc = soc_GPIO_Func();
					$max = sizeof($gpiofunc);
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $gpiofunc[$i]['gpio']; ?></td>
					<td><?php echo $gpiofunc[$i]['pull']; ?></td>
					<td><?php echo $gpiofunc[$i]['alt0']; ?></td>
					<td><?php echo $gpiofunc[$i]['alt1']; ?></td>
					<td><?php echo $gpiofunc[$i]['alt2']; ?></td>
					<td><?php echo $gpiofunc[$i]['alt3']; ?></td>
					<td><?php echo $gpiofunc[$i]['alt4']; ?></td>
					<td><?php echo $gpiofunc[$i]['alt5']; ?></td>
                </tr>
				<?php 
					}
				?> 
