...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../pages/stats_overview.php"><i class="fa fa-area-chart"></i> General Overview</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Statistics Information <small>Charts Overview</small></h1>
    </section>
    ...
    <!-- /.row -->
		...
		<div class="col-md-4">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Running processes</h3>
	...
	<div class="row">
		...
		<div class="col-md-4">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">eth0 traffic</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="lineChart7" style="height:250px"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
		...
		<div class="col-md-4">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">wlan0 traffic</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="lineChart8" style="height:250px"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
		...
		<div class="col-md-4">
          ...
          <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">hci0 traffic</h3>
            ...
            <div class="box-body">
              <div class="chart">
                <canvas id="lineChart9" style="height:250px"></canvas>
              </div>
            </div>
            <!-- /.box-body -->
          </div>
	...
	var lineChartData4 = {
      ...
      datasets: [
        ...
        },
		{
          ...
          strokeColor: "#298A08",
          pointColor: "#298A08",
          pointStrokeColor: "#298A08",
          pointHighlightFill: "#fff",
          pointHighlightStroke: "#298A08",
          data: [10, 19, 5, 4, 6, 5, 0]
        }
      ]
    };
