...
<head>
  ...
  <title>Pi Fusion | PHP Info</title>
...
<aside class="main-sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="../pages/tools_pla.php"><i class="fa fa-database"></i> PHP Lite Admin</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>PHP Lite Admin <small>Database management for SQLite DB</small></h1>
    </section>
        ...
        <div class="col-md-12">
 	      <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">phpLiteAdmin</h3>
            </div>
            <!-- /.box-header -->
			...
			<div>			
			<?php
			$url = "../tools/phpLiteAdmin/phpliteadmin.php";
			echo "<iframe src=".$url." id='idIframe' width='100%' onload='iframeLoaded()' style='border: none;' allowfullscreen> </iframe>";
			?>
			</div>
			<!-- /frame -->
