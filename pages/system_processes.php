...
<head>
  ...
  <title>Pi Fusion | Processes</title>
...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
			...
			<li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/system_processes.php"><i class="fa fa-server"></i> Running Processes</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Running processes <small>Overview</small></h1>
    </section>
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Running processes table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered">
				...
				<tr>
				  <?php 
					...
					$max = sizeof($processes);
					for ($i=1; $i<$max; $i++) {  // start at 1 - cut headline
					?>	
					<td><?php echo $processes[$i]['user']; ?></td>
					<td><?php echo $processes[$i]['pid']; ?></td>
					<td><?php echo $processes[$i]['cpu']; ?></td>
					<td><?php echo $processes[$i]['mem']; ?></td>
					<td><?php echo $processes[$i]['vsz']; ?></td>
					<td><?php echo $processes[$i]['rss']; ?></td>
					<td><?php echo $processes[$i]['tty']; ?></td>
					<td><?php echo $processes[$i]['stat']; ?></td>
					<td><?php echo $processes[$i]['start']; ?></td>
					<td><?php echo $processes[$i]['time']; ?></td>
					<td><?php echo $processes[$i]['command']; ?></td>
                </tr>
				<?php 
					}
				?> 
