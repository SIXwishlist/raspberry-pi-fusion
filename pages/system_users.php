...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
			...
			<li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/system_users.php"><i class="fa fa-server"></i> Users & Groups</a></li>			
              </ul>
            </li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Users & Groups<small>Overview</small></h1>
    </section>
    ...
    <section class="content">
	  ...
	  <div class="col-md-7">
 	      <div class="box box-solid box-default">
            ...
            <!-- /.box-header -->
            <div class="box-body">
              <table id="users_log" class="table table-bordered">
                <thead>
                <tr>
                  <th>User</th>
                  <th>Port</th>
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">User in groups table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="user_groups" class="table table-bordered">
                <thead>
                <tr>
                  <th>User</th>
                  <th>Groups</th>
				...
				<tr>
				  <?php 
				    $useringroups = sys_User_in_Groups();
					$max = sizeof($useringroups);
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $useringroups[$i]['user']; ?></td>
					<td><?php echo $useringroups[$i]['groups']; ?></td>
                </tr>
				<?php 
					}
				?> 
			...
			<table id="groups" class="table table-bordered">
				...
				<tr>
				  <?php 
					...
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $groups[$i]['group']; ?></td>
					<td><?php echo $groups[$i]['pwd']; ?></td>
					<td><?php echo $groups[$i]['gid']; ?></td>
					<td><?php echo $groups[$i]['ulist']; ?></td>
                </tr>
				<?php 
					}
				?> 
			...
			<table id="users" class="table table-bordered">
				...
				<tr>
				  <?php 
					...
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $users[$i]['user']; ?></td>
					<td><?php echo $users[$i]['pwd']; ?></td>
					<td><?php echo $users[$i]['uid']; ?></td>
					<td><?php echo $users[$i]['gid']; ?></td>
                </tr>
				<?php 
					}
				?> 
