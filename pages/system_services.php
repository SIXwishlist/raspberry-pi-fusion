...
<head>
  ...
  <title>Pi Fusion | Services</title>
...
<aside class="main-sidebar">
          ...
          <ul class="treeview-menu">
			...
			<li class="active">
              ...
              <ul class="treeview-menu">
				...
				<li class="active"><a href="../pages/system_services.php"><i class="fa fa-server"></i> Running Services</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Running services <small>Overview</small></h1>
    </section>
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Running services table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered table-striped">
				...
				<tr>
				  <?php 
					...
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $services[$i]['service']; ?></td>
					<td><span class="<?php echo $services[$i]['badge']; ?>"><?php echo $services[$i]['label']; ?></span></td>
                </tr>
				<?php 
					}
				?> 
