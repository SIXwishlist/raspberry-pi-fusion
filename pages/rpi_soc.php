...
<aside class="main-sidebar">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active">
              ...
              <ul class="treeview-menu">
				<li class="active"><a href="../pages/rpi_soc.php"><i class="fa fa-microchip"></i> Board & SoC</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Board & SoC <small>Measurements takes some seconds</small></h1>
    </section>
	...
	<div class="row">
        <div class="col-md-4">
 	      <div class="box box-solid box-default">
			...
			<center>
			<img class="img-responsive" src="../documentation/boards/<?php echo board_Details() ['image']; ?>" width="80%" height="80%" alt="Your board">
			</center>
              ...
              <table class="table table-bordered">
				...
				<tr>
                  <td>Revision:</td>
                  <td>Generation: <?php echo board_Details() ['generation']; ?><br>Model: <?php echo board_Details() ['model']; ?><br>PCB rev: <?php echo board_Details() ['pcb_rev']; ?><br>Released: <?php echo board_Details() ['released']; ?><br>Revison #: <?php echo board_Details() ['revision']; ?></td>
                </tr>
                <tr>
                  <td>Serial #:</td>
		...
		<div class="col-md-4">
 	      <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">SoC configuration <small>Integer values</small></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="soc_config" class="table table-bordered">
                <thead>
                <tr>
                  <th>Feature</th>
                  <th>Value</th>
				...
				<tr>
				  <?php 
					...
					$max = sizeof($soc_config);
					for ($i=0; $i<$max; $i++) {
					?>	
					<td><?php echo $soc_config[$i]['feature']; ?></td>
					<td><?php echo $soc_config[$i]['value']; ?></td>
                </tr>
				<?php 
					}
				?> 
	...
	<div class="row">
        <div class="col-md-4">
 	      <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">SoC frequencies</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table class="table table-bordered">
                ...
                <tr>
                  <td>ARM:</td>
				  <td><?php echo soc_Freq() [0]['freq'] . ' MHz'; ?></td>
                </tr>
                <tr>
                  <td>CORE:</td>
                  <td><?php echo soc_Freq() [1]['freq'] . ' MHz'; ?></td>
                </tr>
		        <tr>
				  <td>DPI:</td>
                  <td><?php echo soc_Freq() [2]['freq'] . ' MHz'; ?></td>
                </tr>
                <tr>
                  <td>EMMC:</td>
                  <td><?php echo soc_Freq() [3]['freq'] . ' MHz'; ?></td>
                </tr>
                <tr>
                  <td>H264:</td>
                  <td><?php echo soc_Freq() [4]['freq'] . ' MHz'; ?></td>
                </tr>
				<tr>
                  <td>HDMI:</td>
                  <td><?php echo soc_Freq() [5]['freq'] . ' MHz'; ?></td>
                </tr>
				<tr>
                  <td>ISP:</td>
                  <td><?php echo soc_Freq() [6]['freq'] . ' MHz'; ?></td>
                </tr>				<tr>
                  <td>PIXEL:</td>
                  <td><?php echo soc_Freq() [7]['freq'] . ' MHz'; ?></td>
                </tr>
				<tr>
                  <td>PWM:</td>
                  <td><?php echo soc_Freq() [8]['freq'] . ' MHz'; ?></td>
                </tr>
				<tr>
                  <td>UART:</td>
                  <td><?php echo soc_Freq() [9]['freq'] . ' MHz'; ?></td>
                </tr>
				<tr>
                  <td>V3D:</td>
                  <td><?php echo soc_Freq() [10]['freq'] . ' MHz'; ?></td>
                </tr>
				<tr>
                  <td>VEC:</td>
                  <td><?php echo soc_Freq() [11]['freq'] . ' MHz'; ?></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
		...
		<div class="col-md-4">
          ...
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">SoC codecs</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table class="table table-bordered">
		...
		<div class="col-md-4">
          ...
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">SoC voltages</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body no-padding">
              <table class="table table-bordered">
                ...
                <tr>
                  <td>CORE:</td>
				  <td><?php echo soc_Volt() [0]['volt']; ?></td>
                </tr>
                <tr>
                  <td>SDRAM controller:</td>
                  <td><?php echo soc_Volt() [1]['volt']; ?></td>
                </tr>
		        <tr>
				  <td>SDRAM Input/Output:</td>
                  <td><?php echo soc_Volt() [2]['volt']; ?></td>
                </tr>
                <tr>
                  <td>SDRAM physical:</td>
                  <td><?php echo soc_Volt() [3]['volt']; ?></td>
                </tr>
              </table>
            </div>
            <!-- /.box-body -->
