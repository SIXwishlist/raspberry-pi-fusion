...
<head>
  ...
  <title>Pi Fusion | Revisions</title>
...
<aside class="main-sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="../pages/docu_board_revs.php"><i class="fa fa-book"></i> Board Revisions</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Board revisions <small>Overview</small></h1>
    </section>
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Raspberry Pi boards table</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered">
				...
				$cvs_file = file('../documentation/boards/revisions.csv');
					foreach($cvs_file as $index)	{  // read rows csv file
						$csv_array = str_getcsv ($index, ';');  // delimiter semicolon
							?>
							<td><?php echo $csv_array [0]; ?></td>
							<td><?php echo $csv_array [1]; ?></td>
							<td><?php echo $csv_array [2]; ?></td>
							<td><?php echo $csv_array [3]; ?></td>
							<td><?php echo $csv_array [4]; ?></td>
							<td><?php echo $csv_array [5]; ?></td>
							<td><?php echo $csv_array [6]; ?></td>
							<td><?php echo $csv_array [10]; ?></td>
							<td><?php echo $csv_array [22]; ?></td>
				</tr>
				<?php
					}  // next row
				?>
