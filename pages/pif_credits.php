<?php
include_once '../lib/pif_credits.php';
?>
...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="../pages/pif_credits.php"><i class="fa fa-thumbs-up"></i> Credits</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Credits and 3rd party licenses <small>Overview</small></h1>
    </section>
	...
	<div class="row">
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Credits <small>All licenses can be found in the included folder <i>licenses</i>.</small></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example2" class="table table-bordered">
				...
				<tr>
				  <?php 
					...
					for ($i=2; $i<$max; $i++) {
					?>	
					<td><?php echo $credits[$i]['source']; ?></td>
					<td><?php echo $credits[$i]['purpose']; ?></td>
					<td><?php echo $credits[$i]['author']; ?></td>
					<td><?php echo $credits[$i]['license']; ?></td>
					<td><?php echo $credits[$i]['url']; ?></td>
                </tr>
				<?php 
					}
				?> 
	  ...
	  <div class="row">
		...
		<!-- /.box -->
          <div class="box box-solid box-default">
            <div class="box-header">
              <h3 class="box-title">Contributors <small>All information is voluntary. Send me an email, if you want to be listed.</small></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			<table id="example3" class="table table-bordered">
                <thead>
                <tr>
                  <th>Full name or pseudo</th>
                  <th>Type</th>
                  <th>What has been contributed?</th>
				...
				<tr>
				  <?php 
				    $contributors = pif_Contributors();
					$max = sizeof($contributors);
					for ($i=2; $i<$max; $i++) {
					?>	
					<td><?php echo $contributors[$i]['name']; ?></td>
					<td><?php echo $contributors[$i]['type']; ?></td>
					<td><?php echo $contributors[$i]['what']; ?></td>
					<td><?php echo $contributors[$i]['email']; ?></td>
					<td><?php echo $contributors[$i]['url']; ?></td>
                </tr>
				<?php 
					}
				?> 
